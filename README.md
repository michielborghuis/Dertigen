...
De launcher-iconconfiguratie staat nu correct als een top-level blok in `pubspec.yaml`.
De GitHub Action gebruikt `dart run flutter_launcher_icons`, zodat de projectconfiguratie betrouwbaar wordt gevonden.
